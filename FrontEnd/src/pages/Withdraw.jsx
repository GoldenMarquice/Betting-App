        ...
        <div className="deposit">
            <main>
                ...
                {/* <section className="deposit-payment-details">
                    <h2 className="deposit-header-payment-details">Withdrawal Details</h2>
                    <div className="deposit-payment-type">
                        <label className="deposit-payment-label" htmlFor="paymentType">Withdrawal Type:</label>
                ...
                {/* <section className="deposit-product-info">
                    <div className="deposit-wallet-switcher" id="deposit-switch-product">
                        <div>
                            <button className="submit-payment-button" onClick={handlePayPalPayment}>Withdrawal to PayPal</button>
                            {paymentStatus && <div>Payment Status: {paymentStatus}</div>}
                        </div>
                    </div>
                    <div className="deposit-minimum-amount">
                        <p>
                            <strong>Other Amount </strong><input type="number" id="vol" name="vol" min="0" max="5000" placeholder='$' ></input>
                        </p>
                    </div>
                    <p className="deposit-responsible-gaming" id="deposit-link-responsible-gaming"></p>
